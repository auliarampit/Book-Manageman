            ...
            <section className= "modal-main">
                <div>
                    <div className= "inputGroup">
                        ...
                        {props.success ? <img src={'https://cdn.dribbble.com/users/204025/screenshots/1632701/check.gif'} alt={this.Success} style={{width: '300px', marginLeft: '50%', transform: 'translate(-50%)' }}/>:
